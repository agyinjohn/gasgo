...
/**
 * GET /api/v1/stations/nearby?lat=&lng=&radius=&size=
 */
router.get(
  '/nearby',
  [
...
/** GET /api/v1/stations/:id — public station detail */
...
/** GET /api/v1/stations/:id/reviews?page=&limit= — public station reviews */
...
/** PATCH /api/v1/stations/:id/prices — Update cylinder prices */
router.patch(
  '/:id/prices',
  [
...
/** PATCH /api/v1/stations/:id/inventory — update stock count or pause a size */
router.patch(
  '/:id/inventory',
  [
    body('size').isIn([3, 6, 12]),
...
/** POST /api/v1/stations/:id/exchange-returns
 *  Rider drops off an empty cylinder — increment needsRefillCount
 */
router.post(
  '/:id/exchange-returns',
...
/** PATCH /api/v1/stations/:id/refill-complete
 *  Station marks cylinders as refilled — moves needsRefillCount back to stockCount
 */
router.patch(
  '/:id/refill-complete',
  [body('size').isIn([3, 6, 12]), body('quantity').optional().isInt({ min: 1 })],
...
/** GET /api/v1/stations/:id/orders?status= — station order queue */
...
/** PATCH /api/v1/stations/:id/settings — operating hours + bank account */
router.patch(
  '/:id/settings',
  [
...
/** GET /api/v1/stations/:id/analytics?period=day|week|month */
